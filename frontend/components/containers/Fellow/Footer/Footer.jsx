    ...
    <div className="container mt-5 mb-5">
      ...
      >
        <div className="col-md-12">
          ...
          <h1 className="display-3 mt-3 mb-3 footer-heading">
            <MdHeart fontSize="60px" color="red" beat={true} /> from
            <img
              className="img-fluid ml-3"
              style={{ width: "256px" }}
              src="/mlh-fellowship-banner.png"
            />
          </h1>
      ...
      <div className="container-fluid text-right">
        <a
          href="https://github.com/MLH-Fellowship/FellowshipWrapup"
          className="footer-link"
        >
          <IosCodeWorking fontSize="30px"></IosCodeWorking>
        </a>
      </div>
    </div>
  );
